...
Certain language models have been trained with more input from US-revelant documents.  
Therefore, they need specific instructions to separate the US concepts from the EPO concepts.   
